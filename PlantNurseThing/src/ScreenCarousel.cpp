...
ScreenCarousel::ScreenCarousel(SSD1306& _oled,
...
void ScreenCarousel::drawFrame1(OLEDDisplay* display, OLEDDisplayUiState* state,
                                int16_t x, int16_t y) {
  char res[24];
  char buff[5];
...
void ScreenCarousel::drawFrame2(OLEDDisplay* display, OLEDDisplayUiState* state,
                                int16_t x, int16_t y) {
  char res[24];
  char buff[5];
...
int ScreenCarousel::update() { return ui.update(); }